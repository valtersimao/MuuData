...
public class HistoricoDeSaudeDAO implements DAO{
    ...
    public boolean insert(Object entite) {
        ...
        String sql = "INSERT INTO muudata.historico_de_saude (id_bovino, descricao, observacoes) VALUES (?,?,?) RETURNING id";
    ...
    public boolean update(Object entite) {
        ...
        String sql = "UPDATE muudata.historico_de_saude SET descricao = ?, observacoes = ? WHERE id = ?";
        
        try(PreparedStatement trans = c.prepareStatement(sql)) {
            trans.setString(1, historico.getDescricao());
            trans.setString(2, historico.getObservacoes());
            trans.setInt(3, historico.getId());
    ...
    public Object getById(long id) {
        ...
        String sql = "SELECT id, observacoes, descricao FROM muudata.historico_de_saude WHERE id_bovino = ?";
